...
class MuImageProperties(bpy.types.PropertyGroup):
    invertY: BoolProperty(name="invertY", description="Invert Y-axis (for dds images)", default = False)
    convertNorm: BoolProperty(name="convertNorm", description="Convert GA normal map to RGB", default = False)
