...
mat.name = ''
mat.shaderName = 'KSP/Bumped Specular (Mapped)'
mat.color.name = ''
mat.color.properties.clear()
item_sub_1 = mat.color.properties.add()
item_sub_1.name = '_RimColor'
item_sub_1.value = (0.0, 0.0, 0.0, 0.0)
item_sub_1 = mat.color.properties.add()
item_sub_1.name = '_TemperatureColor'
item_sub_1.value = (0.0, 0.0, 0.0, 0.0)
item_sub_1 = mat.color.properties.add()
item_sub_1.name = '_BurnColor'
...
item_sub_1.value = 1.0
item_sub_1 = mat.float3.properties.add()
item_sub_1.name = '_RimFalloff'
item_sub_1.value = 0.10000000149011612
item_sub_1 = mat.float3.properties.add()
item_sub_1.name = '_UnderwaterFogFactor'
item_sub_1.value = 0.0
mat.float3.index = 4
